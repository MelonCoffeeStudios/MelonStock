...
module.exports = function(passport) {
    ...
    function(req, userID, password, done) {
        ...
        User.findOne({ 'info.userID' :  userID }, function(err, user) {
            ...
            if (user) {
                ...
                newUser.info.userID    = userID;
                newUser.info.password = newUser.generateHash(password);
                newUser.userType = 'root';
                newUser.userTypePretty = "Root User";
                newUser.auth.modifyAllUsers = true;
                newUser.auth.modifyStoreUsers = false;
